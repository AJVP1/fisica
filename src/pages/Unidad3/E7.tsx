...
function Ejercicio7() {
  return (
    <ExerciseLayout number={7}>
      ...
      <p>
        {
          "$$ \\theta = \\arccos\\left(\\frac{15}{17}\\right) \\approx 28{,}1° $$"
        }
      </p>

      <p>Par 3: A = (-4, 2) y B = (7, 14)</p>
      <p>{"$$ A \\cdot B = (-4)(7) + (2)(14) = -28 + 28 = 0 $$"}</p>
      <p>Como el producto punto es cero, los vectores son perpendiculares:</p>
      <p>{"$$ \\theta = 90° $$"}</p>
    </ExerciseLayout>
  );
}
